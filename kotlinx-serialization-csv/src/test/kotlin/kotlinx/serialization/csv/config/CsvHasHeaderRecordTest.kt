...
class CsvHasHeaderRecordTest {
    ...
    @Test
    fun testWithoutHeaderRecords():Unit = Csv {
    ...
    @Test
    fun testWithHeaderRecords():Unit = Csv {
    ...
    @Test
    fun testListWithoutHeaderRecords():Unit = Csv {
        hasHeaderRecord = false
    }.assertEncodeAndDecode(
        "1\n2\n3",
        listOf(
    ...
    @Test
    fun testListWithHeaderRecords():Unit = Csv {
        hasHeaderRecord = true
    }.assertEncodeAndDecode(
        "a\n1\n2\n3",
        listOf(
    ...
    @Test
    fun testMultipleColumns():Unit = Csv {
        hasHeaderRecord = true
    }.assertEncodeAndDecode(
        "a,b\n1,testing",
    ...
    @Test
    fun testMultipleColumnsTrim():Unit = Csv {
        hasHeaderRecord = true
    ...
    @Test
    fun testMultipleColumnsReordered():Unit = Csv {
        hasHeaderRecord = true
    }.assertDecode(
        "b,a\ntesting,1",
        IntStringRecord(1, "testing"),
    ...
    @Test
    fun testListMultipleColumnsReordered():Unit = Csv {
        hasHeaderRecord = true
    }.assertDecode(
        "b,a\ntesting,1\nbar,2",
        listOf(
    ...
    @Test
    fun testNestedRecordWithHeaderReordered():Unit = Csv {
        hasHeaderRecord = true
    }.assertDecode(
    ...
    @Test
    fun testNestedRecordListWithHeaderReordered():Unit = Csv {
        hasHeaderRecord = true
    }.assertDecode(
