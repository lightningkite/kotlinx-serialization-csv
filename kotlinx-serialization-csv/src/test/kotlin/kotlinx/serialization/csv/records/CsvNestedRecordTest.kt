...
class CsvNestedRecordTest {
    ...
    @Test
    fun testNestedRecord():Unit = Csv.assertEncodeAndDecode(
    ...
    @Test
    fun testNestedRecordList():Unit = Csv.assertEncodeAndDecode(
    ...
    @Test
    fun testNestedRecordWithHeader():Unit = Csv {
    ...
    @Test
    fun testNestedRecordListWithHeader():Unit = Csv {
        hasHeaderRecord = true
    }.assertEncodeAndDecode(
        "time,name,data.location.lat,data.location.lon,data.speed,data.info\n0,Alice,0.0,1.0,100,info\n1,Bob,10.0,20.0,50,info2",
        listOf(
    ...
    @Test
    fun testNestedRecordNullableListWithHeader():Unit = Csv {
        hasHeaderRecord = true
    }.assertEncodeAndDecode(
    ...
    @Test
    fun testNestedRecordNullableListWithoutHeader():Unit = Csv {
